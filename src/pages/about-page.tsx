    ...
    <>
      <section className="flex flex-col gap-10 p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-blue-900">Quem somos?</h2>
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink className="font-semibold">Sobre Nós</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div>
          <div className="flex flex-col items-center gap-4 mb-4">
            ...
            <p style={{ textAlign: "justify" }} className="text-sm font-medium">
              ...
              jornada com combustível de qualidade. Gasolina comum e aditivada,
              etanol, diesel e gás GLP.
            </p>
          </div>
          <div className="flex flex-col items-center gap-4 mb-4">
            ...
            <p style={{ textAlign: "justify" }} className="text-sm font-medium">
              ...
              dedicado a revitalizar tanto o corpo quanto a mente, incentivando
              interações significativas e oferecendo um ponto de encontro onde
              conforto, segurança e hospitalidade se unem para tornar cada
              parada memorável.
            </p>
          </div>
          <div className="flex flex-col items-center gap-4 mb-4">
            ...
            <p style={{ textAlign: "justify" }} className="text-sm font-medium">
              ...
              conveniência: Aqui você encontra, bebidas, gelo, sorvetes, carvão,
              guloseimas, aditivos para todos os tipos de veículos e muito mais.
              Venha conhecer!
            </p>
        ...
        <div className="flex flex-col items-center gap-4 mb-4">
          ...
          <p style={{ textAlign: "justify" }} className="text-sm font-medium">
            Bem-vindo à Iargas! Com mais de 25 anos de experiência no mercado de
            combustíveis, somos reconhecidos por nosso compromisso com a
            excelência e dedicação ao cliente. Oferecemos serviços de alta
            qualidade que têm conquistado a confiança de milhares de clientes,
            que recomendam e aprovam a Iargas como uma referência no setor.
            Nosso objetivo é superar suas expectativas e proporcionar uma
            experiência de atendimento que você merece.
          </p>
        </div>
        <div className="flex flex-col items-center gap-4 mb-4">
          <h2 className="text-3xl mb-2 font-black text-blue-900">
